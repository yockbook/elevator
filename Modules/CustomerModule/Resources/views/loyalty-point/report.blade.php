                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('admin.customer.loyalty-point.report', ['transaction_type'=>$query_params['transaction_type']])}}" method="POST">
                                @csrf
                                <div class="row">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column flex-sm-row flex-wrap gap-3 mb-4">
                                ...
                                <div class="statistics-card statistics-card__subscribed-providers border flex-grow-1">
                                    <h2>{{($total_credit - $total_debit)}}</h2>
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                                    <li>
                                                        <a class="dropdown-item"
                                                           href="{{route('admin.customer.loyalty-point.report.download').'?'.http_build_query($query_params)}}">
                                                            {{translate('Excel')}}
                                                        </a>
                                                    </li>
                                                </ul>
                                                ...
                                                <tr>
                                                    ...
                                                    {{--<td>
                                                        @if($transaction->reference)
                                                            <div class="d-flex fz-10">{{translate($transaction->reference)}}</div>
                                                        @else
                                                            <span>---</span>
                                                        @endif
                                                    </td>
                                                    <td><div class="d-flex fz-10">{{translate($transaction->transaction_type)}}</div></td>--}}
