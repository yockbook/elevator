...
class ChattingController extends Controller
{
    ...
    public function __construct(User $user, ChannelList $channel_list, ChannelUser $channel_user, ChannelConversation $channel_conversation, ConversationFile $conversation_file, Serviceman $serviceman)
    {
    ...
    public function index(Request $request): Factory|View|Application
    {
        ...
        $super_admin = $this->user->where(['user_type' => 'super-admin'])->get();

        return view('chattingmodule::provider.index', compact('chat_list', 'super_admin', 'servicemen'));
    }
    ...
    public function conversation(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'template' => view('chattingmodule::provider.partials._conversations', compact('from_user', 'conversation', 'channel_id'))->render()
        ]);
    }
}
