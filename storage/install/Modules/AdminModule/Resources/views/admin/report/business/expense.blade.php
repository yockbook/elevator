                ...
                <div class="col-12">
                    ...
                    <div class="mb-3">
                        <ul class="nav nav--tabs nav--tabs__style2">
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.report.business.expense')}}" class="nav-link active">{{translate('Expense_Report')}}</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="col-xl-3">
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <div class="card flex-row gap-4 p-30 flex-wrap flex-grow-1">
                                    <img width="35" class="avatar" src="{{asset('public/assets/admin-module')}}/img/icons/coupon_discount.png" alt="">
                                    <div class="text-center">
                                        <h2 class="fz-26">{{with_currency_symbol($bonus_amounts)}}</h2>
                                        <span class="fz-12">{{translate('Other_Discount')}}</span>
                                    </div>
                                </div>
                                <!-- End Card -->
                            </div>
                                ...
                                <div class="d-flex flex-wrap align-items-center gap-3">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                            <li><a class="dropdown-item" href="{{route('admin.report.business.expense.download').'?'.http_build_query($query_params)}}">{{translate('Excel')}}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
