                                        ...
                                        <div class="row pb-1 gy-2">
                                            ...
                                            <div class="col-6 col-lg-3">
                                                <div>
                                                    ...
                                                    <p class="opacity-75 text-capitalize">{{$booking->booking_status}}</p>
                                                </div>
                                            </div>
                                            <div class="col-6 col-lg-3">
                                                <div>
                                        ...
                                        <div class="col-md-6 col-xl-4 d-flex justify-content-center">
                                            <div class="d-flex flex-column gap-30">
                                                ...
                                                <div class="c1-light-bg radius-10 py-3 px-4">
                                                    ...
                                                    <h5 class="c1 mb-2">{{isset($booking->provider) ? Str::limit($booking->provider->company_name, 30) : ''}}</h5>
                                                    <ul class="list-info">
                                                        <li>
                                                            <span class="material-icons">phone_iphone</span>
            ...
            <div class="modal-content">
                <form action="{{route('admin.booking.schedule_update',[$booking->id])}}" method="post">
                    ...
                    <div class="modal-body">
                        <input type="datetime-local" id="service_schedule" name="service_schedule" class="form-control" value="{{$booking->service_schedule}}">
                    </div>
